...
\fancypagestyle{firststyle}
{
   ...
   \fancyhead[RE,RO]{\small $author$ \\ $class$-$section$ \\ $due$}
}
...
\newenvironment{solution}
  {\begin{tcolorbox}[title=Solution:,colback=white, fonttitle=\small\bfseries]}
  {\end{tcolorbox}}

\newcommand{\exercise}[1]{\section{\underline{Exercise #1}}}
